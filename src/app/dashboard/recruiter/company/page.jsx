...
// ─── Company Form ─────────────────────────────────────────────────────────────
function CompanyForm({ existing, onSuccess, onCancel }) {
...
export default function CompanyPage({ existingCompany }) {
  const router = useRouter()
  const [company, setCompany] = useState(existingCompany || null)
